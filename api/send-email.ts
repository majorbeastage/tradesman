...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    try {
      ...
      console.error("[send-email] Resend OK but communication_events insert failed:", logMsg)
    ...
    return res.status(500).json({
      ...
      message: msg,
      hint: "Check Vercel env SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, RESEND_API_KEY, and Resend domain verification for the From address.",
    })
  }
}
