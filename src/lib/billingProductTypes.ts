...
export const BILLING_PRODUCT_OPTIONS: { id: BillingProductTypeId; label: string; monthlyUsd: number }[] = [
  ...
  { id: "office_manager", label: "Office Manager", monthlyUsd: 149.99 },
  { id: "estimate_tools_only", label: "Estimate Tools only (1-tool user)", monthlyUsd: 49.99 },
  { id: "basic_package", label: "Basic Package", monthlyUsd: 89.99 },
  { id: "om_entry", label: "Office Manager ENTRY", monthlyUsd: 149.99 },
  { id: "om_pro", label: "Office Manager PRO", monthlyUsd: 199.99 },
  { id: "om_elite", label: "Office Manager ELITE", monthlyUsd: 369.99 },
  { id: "corporate", label: "Corporate", monthlyUsd: 599.99 },
