      ...
      return (
        <div style={{ border: `1px solid ${theme.border}`, borderRadius: 8, overflow: "hidden" }}>
          ...
          <div style={{ padding: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button type="button" onClick={() => onSelect("estimate_line_items")} style={{ padding: "6px 12px", borderRadius: 6, border: `2px solid ${selectedId === "estimate_line_items" ? theme.primary : theme.border}`, background: selectedId === "estimate_line_items" ? theme.primary : theme.background, color: selectedId === "estimate_line_items" ? "white" : theme.text, fontSize: 12, cursor: "pointer" }}>Estimate line items</button>
            <button type="button" onClick={() => onSelect("job_types")} style={{ padding: "6px 12px", borderRadius: 6, border: `2px solid ${selectedId === "job_types" ? theme.primary : theme.border}`, background: selectedId === "job_types" ? theme.primary : theme.background, color: selectedId === "job_types" ? "white" : theme.text, fontSize: 12, cursor: "pointer" }}>Job types (Calendar)</button>
      ...
      return (
        <div style={{ border: `1px solid ${theme.border}`, borderRadius: 8, overflow: "hidden" }}>
          ...
          <div style={{ padding: 8, display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <button type="button" onClick={() => onSelect("completion_settings")} style={{ padding: "6px 12px", borderRadius: 6, border: `2px solid ${selectedId === "completion_settings" ? theme.primary : theme.border}`, background: selectedId === "completion_settings" ? theme.primary : theme.background, color: selectedId === "completion_settings" ? "white" : theme.text, fontSize: 12, cursor: "pointer" }}>Job completion</button>
            ...
            <button type="button" onClick={() => onSelect("custom_receipt")} style={{ padding: "6px 12px", borderRadius: 6, border: `2px solid ${selectedId === "custom_receipt" ? theme.primary : theme.border}`, background: selectedId === "custom_receipt" ? theme.primary : theme.background, color: selectedId === "custom_receipt" ? "white" : theme.text, fontSize: 12, cursor: "pointer" }}>Custom Receipt</button>
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside style={{ width: 260, background: theme.charcoalSmoke, padding: 20, color: "white", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 }}>
          <button
            type="button"
            onClick={() => setAdminPanel("ops")}
            style={{
              padding: "8px 12px",
              borderRadius: 6,
              border: `1px solid rgba(255,255,255,0.35)`,
              background: adminPanel === "ops" ? "rgba(249,115,22,0.45)" : "rgba(0,0,0,0.2)",
              color: "white",
              fontSize: 13,
              cursor: "pointer",
              fontWeight: adminPanel === "ops" ? 600 : 400,
              textAlign: "left",
            }}
          >
            Ops inbox &amp; reporting
