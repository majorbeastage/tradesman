          ...
          >
            ...
            <div>
              ...
              <p style={{ margin: "8px 0 0", opacity: 0.85, fontSize: 12, lineHeight: 1.55 }}>
                <strong>Inbound v2 (store first):</strong> mail to a customer&apos;s Tradesman or verified custom domain is stored in Conversations first. Optional copy forward uses each channel&apos;s{" "}
                <strong>Forward to email</strong> field (myT → Account → Tradesman business email). Legacy{" "}
                <code style={{ fontSize: 11 }}>RESEND_ZOHO_FORWARD_JSON</code> skip-Tradesman forwarding is deprecated — staff use{" "}
                <code style={{ fontSize: 11 }}>@mail.tradesman-us.com</code> on Zoho separately.
              </p>
