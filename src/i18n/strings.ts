...
const CORE: Record<LocaleCode, Record<string, string>> = {
  en: {
    ...
    "nav.account": "Account",
    "nav.insurance-options": "Insurance Options — Coming Soon",
    "layout.menu": "Menu",
    ...
    "dashboard.quickCustomerPaymentsSoon": "Customer payments (coming soon)",
  ...
  es: {
    ...
    "dashboard.quickCustomerPaymentsSoon": "Pagos de clientes (próximamente)",
