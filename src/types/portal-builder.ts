...
export const ACCOUNT_PORTAL_SECTIONS: { id: string; label: string }[] = [
  ...
  { id: "call_forwarding", label: "Answer, forward, whisper & ring hunting" },
  { id: "call_screening", label: "Optional auto-attendant (AI or recorded menu)" },
  { id: "mobile_app", label: "Mobile App and Notifications — push, GPS, alerts" },
  { id: "app_scheme", label: "Appearance — color scheme & custom logo" },
  { id: "google_reserve", label: "Google Reserve — booking calendar" },
...
export const DEFAULT_LEADS_SETTINGS_ITEMS: PortalSettingItem[] = [
  {
    ...
    type: "checkbox",
    label: 'Public contact CTA page (for your website, Google Business profile, and A2P opt-in link)',
  ...
  },
  {
    id: "embed_lead_slug",
    type: "custom_field",
    label: "Your public link ending: …/cta/<you-choose> (letters, numbers, hyphens; at least 3 characters, e.g. acme-roofing)",
    customFieldSubtype: "text",
    dependency: { dependsOnItemId: "embed_lead_enabled", showWhenValue: "checked" },
  },
  {
    id: "public_cta_headline",
    type: "custom_field",
    label: "CTA page headline (optional — defaults to “Request a quote or service call”)",
    customFieldSubtype: "text",
    dependency: { dependsOnItemId: "embed_lead_enabled", showWhenValue: "checked" },
  },
  {
    id: "public_cta_subtitle",
    type: "custom_field",
    label: "CTA page subtitle (optional — short line under the headline)",
...
export const PAGE_CONTROLS: Record<string, PageControl[]> = {
  ...
  calendar: [
    ...
    { id: 'custom_receipt', label: 'Custom Receipt', type: 'button' },
