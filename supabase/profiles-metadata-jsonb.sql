...
COMMENT ON COLUMN public.profiles.metadata IS 'JSON: portal-related profile state (e.g. leadsSettingsValues, conversationsAutomaticRepliesValues, template AI flags).';
